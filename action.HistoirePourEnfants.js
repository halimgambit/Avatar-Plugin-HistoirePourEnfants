...
exports.default = function (state) {
	...
	return new Promise(function (resolve, reject) {
		...
		for (var rule in Config.modules.HistoirePourEnfants.rules) {
			var match = (0, _helpers.syntax)(state.sentence, Config.modules.HistoirePourEnfants.rules[rule]); 
			if (match) break;
		}
		...
		setTimeout(function(){ 
			if (state.debug) info('Action HistoirePourEnfants');
			
			state.action = {
				module: 'HistoirePourEnfants',
				command: rule,
				room: room,
